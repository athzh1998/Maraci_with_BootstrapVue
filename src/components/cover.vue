<template>
  <b-row align-v="center" class="m-0 section1 justify-content-end">
    <b-col md="6" class="p-5">
      <div>
        <h5
          class="text-white text-justify pb-4"
          style="background-color: rgb(0, 6, 22, 0.8)"
        >
        ...
        <div v-else>
          <b-button size="lg" type="submit" class="btn-secondary w-75" style="font-size:20px !important; font-weight:bold;">سجل الآن</b-button>
        </div>
      </div>
    </b-col>
  </b-row>
