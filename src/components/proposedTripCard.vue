    ...
    <b-col md='3' >
      <b-modal hide-footer id="successfulDelete-model" dir="rtl"> 
         ...
         <b-modal id="sureOfDelete-model" hide-footer>
           <template #modal-header="{ close }" class="justify-content-center border-0">
            ...
            <template class="text-center">
          <div class="m-3">
            <h4 class="text-center pb-3">هل انت متأكد من حذف الرحلة الخاصة بك؟</h4>
            <b-row class="justify-content-between">
              <b-col md='5'><b-button v-b-modal.successfulDelete-model @click="$bvModal.hide('sureOfDelete-model')" class="bg-transparent" style="border: 2px solid #026873; color:#026873;"> نعم، احذف الرحلة</b-button></b-col>
              <b-col md='5'>
                <b-button @click="$bvModal.hide('sureOfDelete-model')">لا، لست متأكد</b-button></b-col>
            </b-row>
           </div>
            </template>
      ...
      <div class="zoomImg mb-3">
        ...
        <div class="px-4" >
          ...
          <b-col>
            <b-card-title class="text-left"><h4>{{tripName}}</h4></b-card-title>
          </b-col>
          <b-col>
        ...
        <b-row class="pb-2">
          ...
          <b-col>
            <b-button href="#" v-b-modal.sureOfDelete-model class="detalesBtn border-0">حذف</b-button>
          </b-col>
        </b-row>
        </div>
      </b-card>
