        ...
        <b-container class="sectionsPadding">
            <b-row class='pb-5' style="min-height: calc(100vh - 120px);">
                <b-col md='6' class="pt-4">
                    <b-img
                    src="../../public/img/imgCover.png" alt="catogary 1 Header"
                    class="imgSize">
            ...
            <b-row class='pt-5'>
                <b-col md='3'>
                    <div>
                    <b-dropdown split text="المدينة: " variant="light" class="my-2 w-100">
                ...
                <b-col md='3' >
                    <div>
                    <b-dropdown split text="ترتيب بحسب: " variant="light" class="my-2 w-100">
                    ...
                    <b-input-group class="my-2 w-100">
                        ...
                        <b-input-group-prepend >
                            <span class="input-group-text" size="sm">
                                <b-icon icon="search" aria-hidden="true" class="btn p-0" variant="Secondary"></b-icon></span>
                        </b-input-group-prepend>
                    </b-input-group>
                </b-col>
            </b-row>
            <b-row align-h='center' class="pb-5">
                <post v-for="catogary in Catogaries" :key="catogary.id" :name="catogary.name" :imgSource="catogary.imgSource"></post>
            </b-row>
         </b-container>
    </DashBoardLayout>
</template>
